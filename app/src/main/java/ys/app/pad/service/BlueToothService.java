        ...
        try {//得到连接状态的方法
            ...
            if(state == 0){
                ...
                for(BluetoothDevice device : devices){
                    ...
                    //1536位打印机蓝牙
                    if (deviceType!=1536&&deviceType!=512){
                        Log.i("info","设备类型"+deviceType);
...
//                    if(isConnected){
//                        Log.i("BLUETOOTH","正在连接:"+device.getName());
//                        isOpenBlueTooth=true;
//                        //String deviceAddress="C6:2F:AF:A2:69:85";
...
//                    }
    ...
    public void writeRXCharacteristic(byte[] value)
    {
    	...
    	if (mBluetoothGatt==null){
            Toast.makeText(this,"钱箱打开失败,请检查蓝牙连接",Toast.LENGTH_SHORT).show();
            return;
        }
    	BluetoothGattService RxService = mBluetoothGatt.getService(RX_SERVICE_UUID);
    	showMessage("mBluetoothGatt null"+ mBluetoothGatt);
