...
public class VipSearchItemViewModel extends BaseObservable {
    ...
    public VipSearchItemViewModel(VipInfo model, Context context) {
        this.model = model;
    ...
    public void setModel(VipInfo model) {
        ...
        notifyPropertyChanged(com.android.databinding.library.baseAdapters.BR.model);
    }
}
