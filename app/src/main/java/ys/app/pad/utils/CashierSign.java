...
public class CashierSign {
    ...
    public static byte[] sign(String bpId ,String invokeCashierKey,String channel,String payType,String outTradeNo,String body,String attach,String totalFee
            ,String backPkgName,String backClassPath,String notifUrl,String shande_channel_id,boolean isScanReceive) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        Map<String,String> dataMap=new HashMap<String, String>();
        dataMap.put("bp_id",bpId);
        dataMap.put("channel",channel);
        dataMap.put("pay_type",payType);
        dataMap.put("shande_channel_id",shande_channel_id);
        //dataMap.put("channel_id",shande_channel_id);
        Log.i("orderInfo","生成的订单"+outTradeNo);
        ...
        if (isScanReceive)
            dataMap.put("call_scan","1");

        signKey=getSign(invokeCashierKey,dataMap);
        dataMap.put("sign",signKey);
     ...
     * 退款
     */
    public static byte[] returnMoneySign(String bpId ,String invokeCashierKey,String cashier_trade_no) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        Map<String,String> dataMap=new HashMap<String, String>();
        dataMap.put("action","refund");
        dataMap.put("bp_id",bpId);

        dataMap.put("input_charset",inputCharset);
        dataMap.put("cashier_trade_no",cashier_trade_no);
    ...
    //签名加密方法，只需要调用
    public static String getSign(String invokeCashierKey,Map<String,String> dataMap)  {
